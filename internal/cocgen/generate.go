...
// 或独立运行:go run ./cmd/warspark cocapi generate
package cocgen
...
func genSpecYAML(path string, eps []GenEndpoint) error {
	var b strings.Builder
	b.WriteString("# Clash of Clans API 端点清单(由 cocgen 从 official-swagger.yaml 生成)\n")
...
func genTypesGo(path string, sw *Swagger, defs []string) error {
	var b strings.Builder
	b.WriteString("// Code generated by cocgen from official-swagger.yaml; DO NOT EDIT.\n")
	b.WriteString("// 权威来源: pkg/cocapi/official-swagger.yaml (官方 Swagger 2.0 规范)\n")
	b.WriteString("// 重新生成: go run ./cmd/warspark cocapi generate\n\n")
