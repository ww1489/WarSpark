...
| `docs/product/mvp-scope.md` | 待编写 | P0 | 明确 MVP 做什么、不做什么、验收边界和推迟能力。 | `warspark-prd.md` |
| `docs/product/user-flows.md` | 待编写 | P0 | 记录核心用户流程：截图找阵、战争目标找阵、找阵沉淀阵型库、复盘沉淀资料。 | `warspark-prd.md`, `mvp-scope.md` |
